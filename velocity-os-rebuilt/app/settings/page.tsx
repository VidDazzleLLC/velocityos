          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#00D4FF] focus:outline-none"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-3">
              ...
              <button className="px-4 py-2 border-2 border-[#00D4FF] text-[#00D4FF] font-medium rounded-lg hover:bg-[#00D4FF] hover:text-white transition-all">
                Enable
              </button>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#00D4FF] focus:outline-none">
